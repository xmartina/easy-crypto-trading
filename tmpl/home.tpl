{$siteName = "Easycrypto Trading LTD"}
                    ...
                    <div class="content">
                        <div class="auto-container">
                            ...
                            <div class="btn-box">
                                ...
                                <a href="{$loginUrl}" class="theme-btn btn-style-two"><span class="btn-title">Login</span></a>
                                <a href="{$signUpUrl}" class="theme-btn btn-style-three"><span class="btn-title">Register</span></a>
                ...
                <div class="content-box">
                    <div class="content">
                        <div class="auto-container">
                            ...
                            <div class="text">Artificial Intelligence is taking over and {$siteName} is following the trend. Invest in our automated mining system powered by blockchain technology </div>
                            <div class="btn-box">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="link-box clearfix">
                            <a href="{$aboutUrl}" class="theme-btn btn-style-two"><span class="btn-title">Read More</span></a>
                ...
                <div class="project-block">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            ...
                            <div class="text">Security is always our priority. {$siteName} provides a safe, reliable and stable environment for digital assets trading via web interface and mobile app by adopting GSLB, distributed server clusters and many more advanced technologies. We also invent and develop products according to customers' needs and suggestions to offer the best trading experience available in the industry.
                            </div>
        ...
        <div class="row" align="center">
            ...
            <div class="service-block-three col-lg-3 col-md-6 col-sm-12 wow fadeInLeft">
                <div class="inner-box">
                    ...
                    <div class="link-box"><a href="{$signUpUrl}">Invest Now</a></div>
                </div>
            </div>
